module.exports = {
  ...
  '@dinpay/base-logger': {
    transports: {
      ...
      dailyRotate: {
        options: {
          filename: process.env.DINPAY_LOG || `${process.env.DINPAY_DATA_PATH}/logs/core/${process.env.DINPAY_LEDGER_NAME}.2/%DATE%.log`,
  ...
  '@dinpay/dindb': {
    snapshots: `${process.env.DINPAY_DATA_PATH}/${process.env.DINPAY_LEDGER_NAME}.2/snapshots`
  },
  '@dinpay/dindb-sequelize': {
    dialect: 'sqlite',
    storage: process.env.DINPAY_STORE || `${process.env.DINPAY_DATA_PATH}/database/${process.env.DINPAY_LEDGER_NAME}.2.sqlite`,
    ...
    // database: process.env.DINPAY_DB || 'dinpay_testnet2',
    logging: false,
    redis: {
  ...
  '@dinpay/webhooks': {
    ...
    database: {
      dialect: 'sqlite',
      storage: `${process.env.DINPAY_DATA_PATH}/database/${process.env.DINPAY_LEDGER_NAME}.2/webhooks.sqlite`,
      logging: false
    },
    redis: {
      host: process.env.DINPAY_REDIS_SERVER || 'localhost',
