module.exports = {
  ...
  '@dinpay/base-logger': {
    transports: {
      ...
      dailyRotate: {
        options: {
          filename: process.env.DINPAY_LOG || `${process.env.DINPAY_DATA_PATH}/logs/core/${process.env.DINPAY_LEDGER_NAME}.1/%DATE%.log`,
  ...
  '@dinpay/dindb': {
    snapshots: `${process.env.DINPAY_DATA_PATH}/${process.env.DINPAY_LEDGER_NAME}.1/snapshots`
  },
  ...
  '@dinpay/webhooks': {
    ...
    database: {
      dialect: 'sqlite',
      storage: `${process.env.DINPAY_DATA_PATH}/database/${process.env.DINPAY_LEDGER_NAME}.1/webhooks.sqlite`,
      logging: false
    },
    redis: {
      host: process.env.DINPAY_REDIS_SERVER || 'localhost',
